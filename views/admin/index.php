    ...
    <div class="container-fluid bg-light">
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                ...
                <div class="row mt-n3 card-jumlah-jemaat justify-content-center">
                    ...
                    <div hidden class="card m-2 col-md-2" id="cardTeruna">
                        <div class="card-body text-info">
                            <h6 class="text-center">Teruna</h6>
                            <h5 class="text-center">20</h5>
                        </div>
                    </div>
                    <div hidden class="card m-2 col-md-2" id="cardLansia">
                        <div class="card-body text-warning">
