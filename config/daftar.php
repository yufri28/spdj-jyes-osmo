...
class Daftar
{
    ...
    public function daftar_keluarga_baru()
    {
        ...
        $check_Nkj = mysqli_query($conn, "SELECT nkj FROM tb_keluarga WHERE nkj = '$this->nkj'");
         ...
         alert('nkj sudah digunakan!');
            ...
            foreach ($dataJson as $key => $value) {
                if ($value['kode_rayon'] === $this->kodeRayon) {
                    ...
                    $sukses = mysqli_query($conn, "INSERT INTO tb_keluarga VALUES('$this->nkj','$password','$this->kodeRayon')");
